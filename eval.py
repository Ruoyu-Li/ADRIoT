    ...
    for e in epoches:
        for p in packet_len:
            for s in seq_len:
                ...
                # flow_handler = FlowHandler(packet_length=p, seq_length=s, batch_size=b, epochs=e, config='config/config.csv', mode='T')
                ...
                # cap = PacketCapturer(stream_type)
                flow_handler = FlowHandler(packet_length=p, seq_length=s, batch_size=b, epochs=e, config='config/config.csv', mode='S')
                ...
                # cap = PacketCapturer(stream_type)
                flow_handler = FlowHandler(packet_length=p, seq_length=s, batch_size=b, epochs=e, config='config/config.csv', mode='E')
